...
- **Calendário mensal** com totais por dia; **clique no número do dia** para abrir o modal com os registros (editar/excluir), **+ Ponto** e **comentário do dia** (texto só no modal; ícone ao lado da data se houver comentário — `config.dayComments`). Em telas estreitas a grade permite **rolagem horizontal** para manter largura mínima dos cards
