...
- **Calendário mensal** com **prévia dos pontos** no card (sem editar no card), totais por dia e faixa **“Mais detalhes”** que abre o modal com edição, **+ Ponto** e **comentário do dia** (texto do comentário só no modal; ícone 💬 na faixa se houver comentário — `config.dayComments`). Em telas estreitas a grade permite **rolagem horizontal** para manter largura mínima dos cards
