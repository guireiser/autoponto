...
- **config.holidaysRemoved** (opcional): lista de `YYYY-MM-DD` dos feriados nacionais (2026–2032 em `app.js`, `BR_HOLIDAYS_NATIONAL`) que não devem ser tratados como feriado (nem cor no calendário nem dobro no saldo).
